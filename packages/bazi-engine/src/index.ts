...
// 细粒度计算函数（便于测试与复用）
export { computeFiveElements, judgeStrength, pickFavorable } from './core/fiveElements.js';
export {
  isForward,
  computeLuckStart,
  computeLuckCycles,
...
export { computeShensha } from './core/shensha.js';
export { validateBirthInput } from './core/validate.js';
